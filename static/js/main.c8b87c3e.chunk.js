(this["webpackJsonpblueprint3d-react-test"] = this["webpackJsonpblueprint3d-react-test"] || []).push([
	[0],
	{
		...
		57: function (e, t, a)
		{
			...
			var n = {};
			a.r(n), a.d(n, "configDimUnit", (function ()
			{
				return P
			...
			var i = {};
			a.r(i), a.d(i, "ELogContext", (function ()
			{
				return N
			...
			var s = {};
			a.r(s), a.d(s, "Utils", (function ()
			{
				return Q
			}));
			var o = {};
			a.r(o), a.d(o, "Version", (function ()
			{
				return J
			}));
			var m = {};
			a.r(m), a.d(m, "BP3D_EVENT_CONFIG_CHANGED", (function ()
			{
				return q
			...
			var b = a(6),
				...
				z = function ()
				{
					...
					return Object(g.a)(e, null, [
					{
						...
						value: function (e, t)
						{
							this.data[e] = t, document.dispatchEvent(new CustomEvent(ee.BP3D_EVENT_CONFIG_CHANGED,
							{
								detail: Object(T.a)(
								{}, e, t)
							}))
			...
			z.data = {
				defaultPathPrefix: "".concat(U, "Blueprint3D-assets/"),
				dimUnit: S,
				wallHeight: 2.5,
				wallThickness: .1,
				sceneLocked: !1,
				...
				Q = function ()
				{
					...
					},
					{
						...
						value: function (e, t, a, l, n, i)
						{
							...
							return b < 0 || a === n && l === i ? (s = a, o = l) : b > 1 ? (s = n, o = i) : (s = a + b * m, o = l + b * d),
							{
								x: s,
								y: o
							}
					...
					},
					{
						...
						value: function (t)
						{
							for (var a = Math.min(0, Math.min.apply(null, e.map(t, (function (e)
								{
									return e.x
								})))), l = Math.min(0, Math.min.apply(null, e.map(t, (function (e)
								{
									return e.x
			...
			var q = "bp3dEvent.config_changed",
				...
				ee = Object(f.a)(Object(f.a)(Object(f.a)(Object(f.a)(Object(f.a)(Object(f.a)(
				{}, n), l), i), s), o), m),
				te = 0,
				ae = 1,
				le = 2,
				...
				be = function ()
				{
					...
					{
						var n = this;
						Object(_.a)(this, e), this.handleWindowResize = function ()
						{
							var e = n.canvas,
								t = e.parentNode;
						...
						{
							n.context.clearRect(0, 0, n.canvasElement.width, n.canvasElement.height), n.drawGrid(), n.floorplan.getRooms().forEach((function (e)
								{
									n.drawRoom(e)
								...
								function ()
								{
									if (ee.Configuration.getBooleanValue(ee.configDimensionVisible))
									{
										...
										})), e = n.viewmodel.convertX(e) - 50, t = n.viewmodel.convertY(t) - 50;
						...
						}, this.floorplan = t, this.viewmodel = a, this.canvas = l, this.canvasElement = l, this.context = this.canvasElement.getContext("2d");
						var i = this;
						window.addEventListener("resize", (function ()
						{
							i.handleWindowResize()
						})), this.handleWindowResize(), document.addEventListener(ee.BP3D_EVENT_CONFIG_CHANGED, (function (e)
						{
							var t = e.detail;
					...
					return Object(g.a)(e, [
					{
						...
						value: function (e, t, a, l, n)
						{
							...
							{
								e = {
									x: this.viewmodel.convertX(e.x),
									y: this.viewmodel.convertY(e.y)
								}, t = {
									x: this.viewmodel.convertX(t.x),
									y: this.viewmodel.convertY(t.y)
								};
								var s = Object(f.a)(
									{}, e),
									o = Object(f.a)(
								...
								"x" === l ? (s.y = n, o.y = n) : "y" === l && (s.x = n, o.x = n), [
									...
									function ()
									{
										...
										a.push(s), a.push(
										{
											x: "x" === l ? s.x + e : s.x - 3.75,
											y: "x" === l ? s.y - 3.75 : s.y + e
										}), a.push(
										{
											x: "x" === l ? s.x + e : s.x + 3.75,
											y: "x" === l ? s.y + 3.75 : s.y + e
										...
										n.push(o), n.push(
										{
											x: "x" === l ? o.x - e : o.x - 3.75,
											y: "x" === l ? o.y - 3.75 : o.y - e
										}), n.push(
										{
											x: "x" === l ? o.x - e : o.x + 3.75,
											y: "x" === l ? o.y + 3.75 : o.y - e
									...
									}(), this.drawItemLabel(
									{
										x: (s.x + o.x) / 2,
										y: (s.y + o.y) / 2
									}, ee.Dimensioning.cmToMeasure(100 * a), 20, !1, "y" === l ? -Math.PI / 2 : 0)
							}
						}
					},
					{
					...
					},
					{
						...
						value: function (e, t)
						{
							...
							this.context.font = "normal ".concat(a, "px Arial"), this.context.fillStyle = de, this.context.textBaseline = "middle", this.context.textAlign = "center", this.context.strokeStyle = "#ffffff", this.context.lineWidth = 4;
					...
					},
					{
						...
						value: function (e)
						{
							...
							a && this.viewmodel.mode, e.frontEdge && this.drawEdge(e.frontEdge, a), e.backEdge && this.drawEdge(e.backEdge, a), Array.isArray(e.items) && e.items.forEach((function (a)
							{
					...
					},
					{
						...
						value: function (e, t)
						{
							(t *= 100) < 60 || (this.context.font = "normal 12px Arial", this.context.fillStyle = "#000000", this.context.textBaseline = "middle", this.context.textAlign = "center", this.context.strokeStyle = "#ffffff", this.context.lineWidth = 4, this.context.strokeText(ee.Dimensioning.cmToMeasure(t), this.viewmodel.convertX(e.x), this.viewmodel.convertY(e.y)), this.context.fillText(ee.Dimensioning.cmToMeasure(t), this.viewmodel.convertX(e.x), this.viewmodel.convertY(e.y)))
						}
					},
					{
						key: "drawEdge",
						value: function (e, t)
						{
							...
							var l = e.corners(),
								n = this;
							this.drawPolygon(ee.Utils.map(l, (function (e)
							{
					...
					},
					{
						...
						{
							var t = this;
							this.drawPolygon(ee.Utils.map(e.corners, (function (e)
							{
					...
					},
					{
						...
						{
							this.drawCircle(this.viewmodel.convertX(e), this.viewmodel.convertY(t), 7, me), this.viewmodel.lastNode && this.drawLine(this.viewmodel.convertX(a.x), this.viewmodel.convertY(a.y), this.viewmodel.convertX(e), this.viewmodel.convertY(t), 7, ie)
						}
					},
					{
						key: "drawLine",
						value: function (e, t, a, l)
						{
							...
							this.context.beginPath(), this.context.setLineDash([]), s && this.context.setLineDash([3, 6]), this.context.moveTo(e, t), this.context.lineTo(a, l), this.context.lineWidth = n, this.context.strokeStyle = i, this.context.stroke()
						}
					},
					{
						key: "drawPolygon",
					...
					},
					{
						...
						value: function ()
						{
							...
							return t < .5 ? e = 100 : t < 1 ? e = 50 : t < 2 ? e = 25 : t < 4 && (e = 12.5), (t || .5) * e
						}
					},
					{
					...
					},
					{
						...
						value: function ()
						{
							for (var e = this.calculateGridOffset(-this.viewmodel.originX), t = this.calculateGridOffset(-this.viewmodel.originY), a = this.canvasElement.width, l = this.canvasElement.height, n = this.calculateGridSpacing(), i = 0; i <= a / n; i++) this.drawLine(n * i + e, 0, n * i + e, l, 1, ne);
				...
				he = a(13),
				ye = {
					url: "".concat(ee.Configuration.getStringValue("defaultPathPrefix"), "/rooms/textures/blank.png"),
					stretch: !0,
					scale: 0
				},
				ue = function ()
				{
					function e(t, a)
					{
						...
						}, this.handleEndMoved = function (e, t, a, n)
						{
							...
							l.moveWallItems(i)
						}, this.start = t, this.end = a, this.id = this.getUuid(), this.start.attachStart(this), this.end.attachEnd(this), this.start.moved_callbacks.push(this.handleStartMoved), this.end.moved_callbacks.push(this.handleEndMoved)
					}
					return Object(g.a)(e, [
					{
						key: "getUuid",
					...
					},
					{
						...
						value: function (e)
						{
							var t = e.prev,
								a = e.current;
							this.items.length && this.items.forEach((function (e)
							{
								var l = e.position,
					...
					},
					{
						...
						value: function ()
						{
							this.frontEdge && this.frontEdge.redrawCallbacks.forEach((function (e)
							{
								return "function" === typeof e && e()
							})), this.backEdge && this.backEdge.redrawCallbacks.forEach((function (e)
							{
								return "function" === typeof e && e()
							}))
						}
					...
					},
					{
						...
						{
							var e = this;
							this.start.detachWall(this), this.end.detachWall(this), this.deleted_callbacks.forEach((function (t)
							{
								return "function" === typeof t && t(e)
							}))
						}
						...
						value: function (e)
						{
							if (e > 0)
							{
								...
								if (this.start.locked || this.end.locked)
									if (this.start.locked && !this.end.locked) a = {
										x: this.getStartX(),
										y: this.getStartY()
									};
									else
				...
				_e = function ()
				{
					function e(t, a, l, n)
					{
						Object(_.a)(this, e), this.wallStarts = [], this.wallEnds = [], this.moved_callbacks = [], this.deleted_callbacks = [], this.action_callbacks = [], this.locked = !1, this.floorplan = t, this.x = a, this.y = l, this.id = n || ee.Utils.guid()
					}
					return Object(g.a)(e, [
					{
						key: "fireOnMove",
					...
					},
					{
						...
						value: function ()
						{
							var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : .25,
								...
								a = this;
							return this.adjacentCorners().forEach((function (l)
							{
					...
					},
					{
						...
						value: function (e, t)
						{
							...
							if (!this.locked)
							{
								var n = this.x,
									i = this.y;
								this.x = e, this.y = t, this.mergeWithIntersected(), l && this.snapToAxis(), this.moved_callbacks.forEach((function (e)
								{
					...
					},
					{
						...
						value: function (e)
						{
							for (var t = 0; t < this.wallStarts.length; t++)
								if (this.wallStarts[t] === e) return !0;
							for (t = 0; t < this.wallEnds.length; t++)
								if (this.wallEnds[t] === e) return !0;
							return !1
						}
					},
					{
					...
					},
					{
						...
						{
							for (var t = 0; t < this.wallStarts.length; t++)
								if (this.wallStarts[t].getEnd() === e) return this.wallStarts[t];
							return null
						}
					},
					{
						...
						value: function (e)
						{
							for (var t = 0; t < this.wallEnds.length; t++)
								if (this.wallEnds[t].getStart() === e) return this.wallEnds[t];
							return null
						}
					},
					{
					...
					},
					{
						...
						value: function ()
						{
							for (var e = 0; e < this.floorplan.getCorners().length; e++)
							{
								...
								if (this.distanceFromCorner(t) < .2 && t !== this) return this.combineWithCorner(t), !0
							}
							for (e = 0; e < this.floorplan.getWalls().length; e++)
							{
								var a = this.floorplan.getWalls()[e];
								if (this.distanceFromWall(a) < .2 && !this.isWallConnected(a))
								{
					...
					},
					{
						...
						value: function ()
						{
							for (var e = {}, t = {}, a = this.wallStarts.length - 1; a >= 0; a--) this.wallStarts[a].getEnd() === this || this.wallStarts[a].getEnd().id in e ? this.wallStarts[a].remove() : e[this.wallStarts[a].getEnd().id] = !0;
				...
				ge = function ()
				{
					function e(t, a, l)
					{
						Object(_.a)(this, e), this.plane = null, this.interiorTransform = new ce.P, this.invInteriorTransform = new ce.P, this.exteriorTransform = new ce.P, this.invExteriorTransform = new ce.P, this.redrawCallbacks = [], this.generatePlane = function ()
						{
							function e(e)
							{
							...
							var i = new ce.t;
							i.vertices = [t, a, l, n], i.faces.push(new ce.q(0, 1, 2)), i.faces.push(new ce.q(0, 2, 3)), i.computeFaceNormals(), i.computeBoundingBox(), this.plane = new ce.Q(i, new ce.R), this.plane.visible = !1, this.plane.edge = this, this.computeTransforms(this.interiorTransform, this.invInteriorTransform, this.interiorStart(), this.interiorEnd()), this.computeTransforms(this.exteriorTransform, this.invExteriorTransform, this.exteriorStart(), this.exteriorEnd())
						}, this.room = t, this.wall = a, this.front = l || !1, this.offset = a.thickness / 2, this.height = a.height, this.front ? this.wall.frontEdge = this : this.wall.backEdge = this
					}
					return Object(g.a)(e, [
					{
						key: "getTexture",
					...
					},
					{
						...
						value: function (e, t, a, l, n)
						{
							...
							this.front ? this.wall.frontTexture = i : this.wall.backTexture = i, this.redrawCallbacks.forEach((function (e)
							{
								return "function" === typeof e && e()
							}))
						}
					...
					},
					{
						...
						value: function ()
						{
							...
							return {
								x: this.getStart().x + e.x,
								y: this.getStart().y + e.y
							}
						}
					},
					{
				...
				xe = {
					url: "".concat(ee.Configuration.getStringValue("defaultPathPrefix"), "/rooms/textures/marbletiles.jpg"),
					scale: 4
				},
				De = function ()
				{
					function e(t, a)
					{
						Object(_.a)(this, e), this.interiorCorners = [], this.edgePointer = null, this.floorPlane = null, this.customTexture = !1, this.floorChangeCallbacks = [], this.floorplan = t, this.corners = a, this.updateWalls(), this.updateInteriorCorners(), this.generatePlane()
					}
					return Object(g.a)(e, [
					{
						key: "getUuid",
					...
					},
					{
						...
						value: function (e)
						{
							var t = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1],
								...
								l = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : .5,
								n = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : .5;
							console.log("set texture of room", e, t, a);
							var i = this.getUuid();
							this.floorplan.setFloorTexture(i, e, a, l, n), this.floorChangeCallbacks.forEach((function (e)
							{
								return "function" === typeof e && e()
							}))
						}
					},
					{
						...
						value: function ()
						{
							...
							var t = new ce.vb(e),
								a = new ce.wb(t);
							this.floorPlane = new ce.Q(a, new ce.R(
							{
								side: ce.o
							})), this.floorPlane.visible = !1, this.floorPlane.rotation.set(Math.PI / 2, 0, 0), this.floorPlane.room = this
						}
					},
					{
						key: "cycleIndex",
				...
				fe = function ()
				{
					...
					{
						var t = this;
						Object(_.a)(this, e), this.scene = null, this.walls = [], this.corners = [], this.rooms = [], this.new_wall_callbacks = [], this.new_corner_callbacks = [], this.redraw_callbacks = [], this.updated_rooms = [], this.roomLoadedCallbacks = [], this.floorTextures = {}, this.removeCorner = function (e)
						{
					...
					return Object(g.a)(e, [
					{
						...
						{
							var e = [];
							return this.walls.forEach((function (t)
							{
					...
					},
					{
						...
						value: function (e, t)
						{
							...
							this.walls.push(a);
							var l = this;
							return a.fireOnDelete((function ()
							{
								l.removeWall(a)
					...
					},
					{
						...
						value: function (e, t, a)
						{
							...
							return this.corners.push(l), l.fireOnDelete(this.removeCorner), this.new_corner_callbacks.forEach((function (e)
							{
					...
					},
					{
						...
						{
							a = a || .05;
							for (var l = 0; l < this.corners.length; l++)
								if (this.corners[l].distanceFrom(e, t) < a) return this.corners[l];
							return null
						}
					},
					{
						...
						value: function (e, t, a)
						{
							...
							for (var l = 0; l < this.walls.length; l++)
								if (this.walls[l].distanceFrom(e, t) < a) return this.walls[l];
							return null
						}
					},
					{
					...
					},
					{
						...
						value: function ()
						{
							var e = Object(he.a)(this.getCorners().map((function (e)
							{
								return {
									x: e.x,
									y: e.y
							...
							for (l = 0; l < t.length - 1; l++) d.x.push(
							{
								start: t[l],
								end: t[l + 1],
								length: Math.abs(t[l].x - t[l + 1].x)
							});
							for (l = 0; l < a.length - 1; l++) d.y.push(
							{
								start: a[l],
								end: a[l + 1],
								length: Math.abs(a[l].y - a[l + 1].y)
							});
							return d
						}
					},
					{
						...
						value: function ()
						{
							...
							return this.corners.forEach((function (t)
							{
								e.corners[t.id] = {
									x: t.x,
									y: t.y
							...
							})), this.walls.forEach((function (t)
							{
								e.walls.push(
								{
									corner1: t.getStart().id,
									corner2: t.getEnd().id,
									frontTexture: t.frontTexture,
									backTexture: t.backTexture
								})
							})), e.newFloorTextures = this.floorTextures, e
						}
					},
					{
						key: "loadFloorplan",
						value: function (e)
						{
							...
							if (null !== e && "corners" in e && "walls" in e)
							{
								...
								})), "newFloorTextures" in e && (this.floorTextures = e.newFloorTextures), this.update(), this.roomLoadedCallbacks.forEach((function (e)
								{
									return "function" === typeof e && e()
								}))
							}
					...
					},
					{
						...
						value: function ()
						{
							...
							})), this.assignOrphanEdges(), this.updateFloorTextures(), this.updated_rooms.forEach((function (e)
							{
								return "function" === typeof e && e()
							}))
						}
					...
					},
					{
						...
						value: function (e)
						{
							...
							var t = 1 / 0,
								...
								l = 1 / 0,
								n = -1 / 0;
							return this.corners.forEach((function (e)
							{
								e.x < t && (t = e.x), e.x > a && (a = e.x), e.y < l && (l = e.y), e.y > n && (n = e.y)
							})), t === 1 / 0 || a === -1 / 0 || l === 1 / 0 || n === -1 / 0 ? new ce.Lb : e ? new ce.Lb(.5 * (t + a), 0, .5 * (l + n)) : new ce.Lb(a - t, 0, n - l)
						}
					},
					{
								...
								e.adjacentCorners().forEach((function (l)
								{
									a.push(function (e, a)
									{
										...
										for (var s = function ()
											{
												var s = n.corner;
												if (i[s.id] = !0, n.corner === e && s !== a) return {
													v: n.previousCorners
												};
				...
				ke = function (e)
				{
					...
					{
						var n;
						return Object(_.a)(this, a), (n = t.call(this)).scene = e.scene, n.item = l, n.frameMaterial = new ce.T(
						{
							color: 14540253
						}), n.offsetCenter = new ce.Lb, n.canvasDepth = document.createElement("canvas"), n.canvasWidth = document.createElement("canvas"), n.canvasHeight = document.createElement("canvas"), n.sizeOrigin = JSON.parse(JSON.stringify(l.halfSize)), n.configFrames(), n.configLabels(), n.drawLabels(n.item.halfSize), ee.Configuration.getBooleanValue(ee.configDimensionVisible) || (n.visible = !1), document.addEventListener(ee.BP3D_EVENT_CONFIG_CHANGED, (function (e)
						{
							var t = e.detail;
					...
					return Object(g.a)(a, [
					{
						...
						value: function ()
						{
							...
							for (var l = 0; l < this.children.length; l++)
							{
								...
								l >= 0 && l < 4 ? (n.scale.z = e.z / this.sizeOrigin.z, l % 4 === 0 && n.position.set(-e.x + this.offsetCenter.x, e.y + this.offsetCenter.y, this.offsetCenter.z), l % 4 === 1 && n.position.set(e.x + this.offsetCenter.x, e.y + this.offsetCenter.y, this.offsetCenter.z), l % 4 === 2 && n.position.set(e.x + this.offsetCenter.x, -e.y + this.offsetCenter.y, this.offsetCenter.z), l % 4 === 3 && n.position.set(-e.x + this.offsetCenter.x, -e.y + this.offsetCenter.y, this.offsetCenter.z)) : l >= 4 && l < 8 ? (n.scale.x = e.x / this.sizeOrigin.x, l % 4 === 0 && n.position.set(this.offsetCenter.x, -e.y + this.offsetCenter.y, e.z + this.offsetCenter.z), l % 4 === 1 && n.position.set(this.offsetCenter.x, e.y + this.offsetCenter.y, e.z + this.offsetCenter.z), l % 4 === 2 && n.position.set(this.offsetCenter.x, e.y + this.offsetCenter.y, -e.z + this.offsetCenter.z), l % 4 === 3 && n.position.set(this.offsetCenter.x, -e.y + this.offsetCenter.y, -e.z + this.offsetCenter.z)) : l >= 8 && l < 12 ? (n.scale.y = e.y / this.sizeOrigin.y, l % 4 === 0 && n.position.set(-e.x + this.offsetCenter.x, this.offsetCenter.y, e.z + this.offsetCenter.z), l % 4 === 1 && n.position.set(e.x + this.offsetCenter.x, this.offsetCenter.y, e.z + this.offsetCenter.z), l % 4 === 2 && n.position.set(e.x + this.offsetCenter.x, this.offsetCenter.y, -e.z + this.offsetCenter.z), l % 4 === 3 && n.position.set(-e.x + this.offsetCenter.x, this.offsetCenter.y, -e.z + this.offsetCenter.z)) : l >= 12 && l < 16 ? (n.material.map.needsUpdate = !0, l % 4 === 0 && n.position.set(-e.x + this.offsetCenter.x, e.y + this.offsetCenter.y, this.offsetCenter.z), l % 4 === 1 && n.position.set(e.x + this.offsetCenter.x, e.y + this.offsetCenter.y, this.offsetCenter.z), l % 4 === 2 && n.position.set(e.x + this.offsetCenter.x, -e.y + this.offsetCenter.y, this.offsetCenter.z), l % 4 === 3 && n.position.set(-e.x + this.offsetCenter.x, -e.y + this.offsetCenter.y, this.offsetCenter.z)) : l >= 16 && l < 20 ? (n.material.map.needsUpdate = !0, l % 4 === 0 && n.position.set(this.offsetCenter.x, e.y + this.offsetCenter.y, e.z + this.offsetCenter.z), l % 4 === 1 && n.position.set(this.offsetCenter.x, -e.y + this.offsetCenter.y, e.z + this.offsetCenter.z), l % 4 === 2 && n.position.set(this.offsetCenter.x, e.y + this.offsetCenter.y, -e.z + this.offsetCenter.z), l % 4 === 3 && n.position.set(this.offsetCenter.x, -e.y + this.offsetCenter.y, -e.z + this.offsetCenter.z)) : l >= 20 && l < 24 && (n.material.map.needsUpdate = !0, l % 4 === 0 && n.position.set(-e.x + this.offsetCenter.x, this.offsetCenter.y, e.z + this.offsetCenter.z), l % 4 === 1 && n.position.set(e.x + this.offsetCenter.x, this.offsetCenter.y, e.z + this.offsetCenter.z), l % 4 === 2 && n.position.set(e.x + this.offsetCenter.x, this.offsetCenter.y, -e.z + this.offsetCenter.z), l % 4 === 3 && n.position.set(-e.x + this.offsetCenter.x, this.offsetCenter.y, -e.z + this.offsetCenter.z))
							}
						}
					},
					{
					...
					},
					{
						...
						value: function ()
						{
							var e = this.item.halfSize,
								...
								l = (new ce.Cb).copy(t),
								n = (new ce.Cb).copy(t);
							t.position.set(-e.x, e.y, 0), a.position.set(e.x, e.y, 0), l.position.set(e.x, -e.y, 0), n.position.set(-e.x, -e.y, 0), a.visible = l.visible = n.visible = !1, this.add(t), this.add(a), this.add(l), this.add(n);
							var i = this.makeTextSprite(this.canvasWidth),
								s = (new ce.Cb).copy(i),
								o = (new ce.Cb).copy(i),
								m = (new ce.Cb).copy(i);
							i.position.set(0, e.y, e.z), s.position.set(0, -e.y, e.z), o.position.set(0, e.y, -e.z), m.position.set(0, -e.y, -e.z), s.visible = o.visible = m.visible = !1, this.add(i), this.add(s), this.add(o), this.add(m);
							var d = this.makeTextSprite(this.canvasHeight),
								b = (new ce.Cb).copy(d),
								r = (new ce.Cb).copy(d),
								p = (new ce.Cb).copy(d);
							d.position.set(-e.x, 0, e.z), b.position.set(e.x, 0, e.z), r.position.set(e.x, 0, -e.z), p.position.set(-e.x, 0, -e.z), b.visible = r.visible = p.visible = !1, this.add(d), this.add(b), this.add(r), this.add(p)
						}
					},
					{
						key: "setSelected",
					...
					},
					{
						...
						value: function (e)
						{
							this.drawCanvas(this.canvasDepth, ee.Dimensioning.cmToMeasure(2 * e.z * 100),
							{
								fontsize: 24,
								color:
								{
							...
							}), this.drawCanvas(this.canvasWidth, ee.Dimensioning.cmToMeasure(2 * e.x * 100),
							{
								fontsize: 24,
								color:
								{
							...
							}), this.drawCanvas(this.canvasHeight, ee.Dimensioning.cmToMeasure(2 * e.y * 100),
							{
								fontsize: 24,
								color:
								{
					...
					},
					{
						...
						value: function (e, t, a)
						{
							...
							var l = a.hasOwnProperty("fontface") ? a.fontface : "Arial",
								...
								i = a.hasOwnProperty("color") ? a.color :
								{
									r: 0,
									g: 0,
									b: 0,
								...
								s = e.getContext("2d");
							s.clearRect(0, 0, e.width, e.height), s.font = "Bold ".concat(n, "px ").concat(l), s.textBaseline = "middle", s.textAlign = "center", s.fillStyle = "rgba(".concat(i.r, ",").concat(i.g, ",").concat(i.b, ",").concat(i.a, ")"), s.fillText(t, e.width / 2, e.height / 2), s.strokeStyle = "#ffffff", s.lineWidth = .1, s.strokeText(t, e.width / 2, e.height / 2)
						}
					},
					{
						key: "makeTextSprite",
						value: function (e)
						{
							...
							var a = new ce.Db(
								...
								l = new ce.Cb(a);
							return l.renderOrder = 100, l.scale.set(1, .75, 1), l
						}
					},
					{
						key: "setPosition",
				...
				Ge = function (e, t)
				{
					var a, l = arguments.length > 2 && void 0 !== arguments[2] && arguments[2],
					...
					try
					{
						var d = function ()
						{
							var t = a.value,
								m = !1,
								d = [];
							if (d.push.apply(d, Oe), i && d.push.apply(d, je), d.forEach((function (e)
								{
							...
							try
							{
								if (Array.isArray(t.morphTargetInfluences))
								{
									...
									for (b = 0; b < p; b++)
										for (var c = t.geometry.morphAttributes.position[b].array, h = 0; h < r.length; h++) r[h] = r[h] + c[h] * t.morphTargetInfluences[b]
								}
							}
							catch (x)
							{}
				...
				{
					var a = [];
					if (Ge(e, e.children, !0, !1, !0).forEach((function (e)
						{
							var t = (e.length < 16 ? Ie : Re)(e.map((function (e)
							{
								return [e.x, e.z]
							})));
							a.push(t.map((function (e)
							{
								return {
									x: e[0],
									y: e[1]
				...
				Ve = function (e)
				{
					...
					function a(e, l, n, i, s, o)
					{
						...
						{
							var t = !1;
							return m.linkedItems.forEach((function (a)
							{
								e === a && (t = !0)
							})), t
						...
						{
							var e = [];
							return e.push((new ce.Lb).copy(m.position)), m.linkedItems.forEach((function (t)
								{
						...
						}, m.flipHorizontal = function () {}, m.changed = function ()
						{
						...
						}, m.getSnapPoints = function ()
						{
							...
							{
								var t = [];
								return m.hullPointsCollection.forEach((function (e)
								{
						...
						}, m.updateMaterial = function (e, t)
						{
							...
							{
								var n = Object(u.a)(y.a.mark((function n(i)
								{
									var s, o, m;
						...
						{
							m.styles[e] = t, m.linkedItems.forEach((function (l)
							{
								return l.updateStyle(e, t, a)
							})), m.traverse((function (a)
							{
								if ("lock" !== e || !a.name.includes("block")) try
								{
						...
						}, m.updateBlocksByHeight = function (e)
						{
							...
							{
								var i = m.children[n];
								i.name.includes(l) && (i.visible = !0), i.name.includes(Be) && (m.scene.remove(i), m.children.splice(n, 1)), i.name.includes(l) && !i.name.includes(Be) && (t = i), i.name.includes("(block-top)") && (a = i)
							}
							if (t)
							{
								var s = 0;
						...
						}, m.updateBlocksByWidth = function (e)
						{
							...
							if (a)
							{
								...
								r && r[1] && (i = parseFloat(r[1].replace(",", ".")), i *= .0254, s = d = e / (o = Math.floor(e / i)));
						...
						}, m.model = e, m.scene = m.model.scene, m.metadata = l, Array.isArray(n) && n.forEach((function (e)
						{
							m.add(e);
						...
						})), m.centerOffset = new ce.Lb, m.morph = {}, m.textures = {}, m.styles = {}, m.blockCount = 1, m.errorColor = 16711680, m.resizable = l.resizable, m.castShadow = !0, m.receiveShadow = !1, m.linkedItems = [], m
					}
					return Object(g.a)(a, [
					{
						key: "prepareMeshes",
											...
											e.geometryBackup = s,
												...
												function ()
												{
													if (e.name.includes("glass"))
													{
														...
														var l = e.material;
														l.transparent = !0, l.roughness = l.metalness = e.name.includes("acrylic") ? .5 : 0, l.transmission = .8, l.thickness = 1, l.color.setHex(8947848), l.envMap = t.scene.environment, l.envMapIntensity = 2, l.emissive.setHex(4473924), console.log(l)
													}
												}(),
												function ()
												{
					...
					},
					{
						...
						value: function ()
						{
							...
							try
							{
								...
								return (e || JSON.stringify(l) !== JSON.stringify(this.prevPosition) || JSON.stringify(i) !== JSON.stringify(this.morph) || n !== this.prevRotation) && (this.boundingGizmo = ze(t, a), this.prevPosition = l, this.prevRotation = n, this.prevMorph = i), this.boundingGizmo
							}
							catch (s)
							{
								return null
					...
					},
					{
						...
						value: function ()
						{
							var e, t = Object(L.a)(this.childMeshes);
							try
							{
								for (t.s(); !(e = t.n()).done;)
								{
					...
					},
					{
						...
						value: function (e, t)
						{
							...
							try
							{
								var a = ze(this);
								a = a.max.sub(a.min);
								var l, n = Object(L.a)(this.children);
								try
								{
									for (n.s(); !(l = n.n()).done;)
									{
								...
								var s, o = Object(L.a)(this.childMeshes);
								try
								{
									for (o.s(); !(s = o.n()).done;)
									{
								...
								this.centerOffset = b.sub(this.position), this.centerOffset.y = 0, parseInt(e, 10) === parseInt(this.metadata.blockMorphIndex, 10) && this.updateBlocksByHeight(2.54 * (5 + 295 * t) / 100), parseInt(e, 10) === parseInt(this.metadata.horizontalBlockMorphIndex, 10) && this.updateBlocksByWidth(2.54 * (5 + 295 * t) / 100);
								var r = ze(this);
					...
					},
					{
						...
						value: function (e, t, a)
						{
							...
							if (0 != e)
							{
								1 == e && 0 != n.x ? 5 === l || 4 === l || 6 === l ? s.x = n.x / 2 : 1 !== l && 2 !== l && 8 !== l || (s.x = -n.x / 2) : 2 == e && 0 != n.z && (3 === l || 4 === l || 2 === l ? s.z = n.z / 2 : 7 !== l && 6 !== l && 8 !== l || (s.z = -n.z / 2));
								var o = new ce.P;
					...
					},
					{
						...
						value: function ()
						{
							var e = this.hover || this.selected,
								t = [],
								a = [];
							a.push.apply(a, Object(he.a)(this.childMeshes)), this.linkedItems.forEach((function (e)
							{
								return a.push.apply(a, Object(he.a)(e.childMeshes))
							})), this.groupParent && a.push.apply(a, Object(he.a)(this.groupParent.childMeshes)), a.forEach((function (e)
							{
								var a = !1;
							...
							})), e ? document.dispatchEvent(new CustomEvent(ee.BP3D_EVENT_HIGHLIGHT_CHANGED,
							{
								detail:
								{
									objects: t
								}
							})) : document.dispatchEvent(new CustomEvent(ee.BP3D_EVENT_HIGHLIGHT_CHANGED,
							{
								detail:
								{
									objects: []
						...
						value: function (e, t)
						{
							if (e)
							{
								...
								var m = (new ce.Lb).copy(this.position).sub(a),
									d = (new ce.Lb).copy(m);
								m.applyMatrix4(o), d = m.sub(d), this.relativeMove(d.x, d.z), this.rotateChildMeshes(), this.rotateLinkedItems(s, a), this.changed(), this.groupParent && this.groupParent.isSet && this.groupParent.update()
							}
						}
					},
					{
					...
					},
					{
						...
						value: function (e, t, a)
						{
							...
							return d.applyMatrix4(m), n.add(d), i.add(d), s.add(d), o.add(d), [
							{
								x: n.x,
								y: n.z
							},
					...
					},
					{
						...
						value: function (e)
						{
							e = e || this.position, this.error || (this.error = !0, this.errorGlow = this.createGlow(this.errorColor, .8, !0), this.scene.add(this.errorGlow)), this.errorGlow.position.copy(e)
						}
					},
					{
						key: "hideError",
					...
					},
					{
						...
						value: function (e, t, a)
						{
							...
							})), s.material = i, s.position.copy(this.position), s.rotation.copy(this.rotation), s.scale.copy(this.scale), s
						}
					}]), a
				}(ce.Q),
				Ae = -1,
				...
				Qe = function (e)
				{
					...
					function a()
					{
						...
						return (e = t.call.apply(t, [this].concat(n))).getBottomObjectsForStack = function ()
						{
							var t = [];
							return e.model.scene.items.forEach((function (e)
							{
							...
							for (var a = e.getCorners("x", "z", t), l = 1 / 0, n = 1 / 0, i = a[0].x, s = a[1].x, o = a[0].y, m = a[2].y, d = e.model.scene.items, b = 0; b < d.length; b++)
								if (d[b] !== Object(ve.a)(e) && d[b].obstructFloorMoves && !e.checkIsLinkedMesh(d[b]))
								{
									...
									try
									{
										...
										{
											var h = r.value;
											Math.abs(i - h.x) < Ye && Math.abs(i - h.x) < Math.abs(l) && (l = h.x - i, l -= l / Math.abs(l) * 0), Math.abs(s - h.x) < Ye && Math.abs(s - h.x) < Math.abs(l) && (l = h.x - s, l -= l / Math.abs(l) * 0), Math.abs(o - h.y) < Ye && Math.abs(o - h.y) < Math.abs(n) && (n = h.y - o, n -= n / Math.abs(n) * 0), Math.abs(m - h.y) < Ye && Math.abs(m - h.y) < Math.abs(n) && (n = h.y - m, n -= n / Math.abs(n) * 0)
										}
									}
									catch (y)
									{
						...
						{
							for (var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [], a = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : e.getCorners("x", "z"), l = e.getBounding(), n = 0; n < t.length; n++)
						...
						{
							for (var a = e.getCorners("x", "z", t), l = e.model.scene.items, n = e.model.floorplan.getRooms(), i = !1, s = 0; s < n.length; s++) ee.Utils.pointInPolygon(t.x, t.z, n[s].interiorCorners) && !ee.Utils.polygonPolygonIntersect(a, n[s].interiorCorners) && (i = !0);
				...
				Je = function (e)
				{
					...
					{
						var m;
						return Object(_.a)(this, a), (m = t.call(this, e, l, n, i, s, o)).currentWallEdge = null, m.refVec = new ce.Kb(0, 1), m.wallOffsetScalar = 0, m.sizeX = 0, m.sizeY = 0, m.addToWall = !1, m.boundToFloor = !1, m.frontVisible = !1, m.backVisible = !1, m.allowRotate = !1, m.morphAlign = 3, m
					}
					return Object(g.a)(a, [
					{
						key: "closestWallEdge",
					...
					},
					{
						...
						value: function (e)
						{
							null != this.currentWallEdge && (this.addToWall ? (ee.Utils.removeValue(this.currentWallEdge.wall.items, this), this.redrawWall()) : ee.Utils.removeValue(this.currentWallEdge.wall.onItems, this)), null != this.currentWallEdge && this.currentWallEdge.wall.dontFireOnDelete(this.remove.bind(this)), e.wall.fireOnDelete(this.remove.bind(this));
							var t = new ce.Kb,
								a = e.plane.geometry.faces[0].normal;
							t.x = a.x, t.y = a.z;
							var l = ee.Utils.angle(this.refVec.x, this.refVec.y, t.x, t.y);
							this.flipped && (l = (l + Math.PI) % (2 * Math.PI)), this.rotation.y = l, this.dimensionHelper.rotation.y = l, this.rotateChildMeshes(), this.currentWallEdge = e, this.addToWall ? (e.wall.items.push(this), this.redrawWall()) : e.wall.onItems.push(this)
						}
					},
					{
						key: "customIntersectionPlanes",
					...
					},
					{
						...
						value: function (e)
						{
							...
							e.applyMatrix4(a.interiorTransform), e.x < this.sizeX / 2 + t ? e.x = this.sizeX / 2 + t : e.x > a.interiorDistance() - this.sizeX / 2 - t && (e.x = a.interiorDistance() - this.sizeX / 2 - t), this.boundToFloor ? e.y = 0 * this.scale.y + .01 : e.y < t ? e.y = t : e.y > a.height - this.sizeY - t && (e.y = a.height - this.sizeY - t), e.z = this.getWallOffset(), e.applyMatrix4(a.invInteriorTransform)
						}
					}]), a
				}(Ve),
				qe = function (e)
				{
					...
					{
						var m;
						return Object(_.a)(this, a), (m = t.call(this, e, l, n, i, s, o)).flipHorizontal = function ()
						{
							m.flipped = !m.flipped, m.rotation.y = (m.rotation.y + Math.PI) % (2 * Math.PI)
						}, m.addToWall = !0, m.morphAlign = 0, m.flippable = !0, m.flipped = !1, m
					}
					return Object(g.a)(a, [
					{
						key: "getWallOffset",
						value: function ()
						{
							return .005 - this.currentWallEdge.offset
						}
					}]), a
				}(Je),
				Ze = function (e)
				...
				tt = function (e)
				{
					...
					function a()
					{
						...
						Object(_.a)(this, a);
						for (var l = arguments.length, n = new Array(l), i = 0; i < l; i++) n[i] = arguments[i];
						return (e = t.call.apply(t, [this].concat(n))).isSet = !0, e.opened = !1, e.initObject = function (e, t, a, l)
						{
							this.halfSize = this.objectHalfSize(), this.configDimensionLabels(), t ? (this.position.copy(t), this.dimensionHelper.position.copy(t), this.position_set = !0) : (this.position.set(0, 0, 0), this.position_set = !1), a && (this.rotation.y = a), this.placeInRoom(), this.scene.needsUpdate = !0
						}, e.clearLinkedItems = function () {}, e.calculateHalfSize = function ()
						{
						...
						}, e.getBounding = function ()
						{
							var t = 1 / 0,
								...
								i = -1 / 0,
								s = -1 / 0;
							return e.linkedItems.forEach((function (e)
							{
								var o = e.getBounding();
					...
					},
					{
						...
						value: function ()
						{
							...
							if (!this.opened)
							{
								...
								})), console.log("update highlight"), e ? document.dispatchEvent(new CustomEvent(ee.BP3D_EVENT_HIGHLIGHT_CHANGED,
								{
									detail:
									{
										objects: t
				...
				it = function ()
				{
					function e(t, a)
					{
						Object(_.a)(this, e), this.items = [], this.needsUpdate = !1, this.itemLoadingCallbacks = [], this.itemLoadedCallbacks = [], this.itemRemovedCallbacks = [], this.collectOptionsFromItem = function (e)
						{
							var t = {},
								a = {},
								l = {};
							...
							return Array.isArray(e.optionGroups) && e.optionGroups.forEach((function (e)
								{
									"hide" === e.mode && e.options.length && (t[e.nameInModel] = e.options[0].nameInModel), "texture" === e.mode && e.options.length && (l[e.nameInModel] = {
										material:
										{
											texture: e.options[0].image
										},
										size:
										{
											w: e.options[0].textureWidth / 100,
											h: e.options[0].textureHeight / 100
										}
									})
								})),
								function ()
								{
									...
									for (var i in t && (a[0] = e.builderOptions.height.minValue, e.modelDescription && e.modelDescription.height && (a[0] = e.modelDescription.height)), l && (a[1] = e.builderOptions.width.minValue, e.modelDescription && e.modelDescription.width && (a[1] = e.modelDescription.width)), n && (a[2] = e.builderOptions.depth.minValue, e.modelDescription && e.modelDescription.depth && (a[2] = e.modelDescription.depth)), a) a[i] = (a[i] - 5) / 295
								}(),
								{
									morph: a,
									styles: t,
					...
					},
					{
						...
						value: function (e, t)
						{
							t = t || !1, this.itemRemovedCallbacks.forEach((function (t)
							{
								return "function" === typeof t && t(e)
							...
							var e = Object(u.a)(y.a.mark((function e(t, a, l, n, i)
							{
								...
								return y.a.wrap((function (e)
								{
									...
									case 2:
										...
										{
											return "function" === typeof e && e()
										})), o = new(nt.Factory.getClass(101))(s.model, Object(f.a)(
										{}, t), [], l, n, i), m = Object(L.a)(a), e.prev = 8, m.s();
									case 10:
										if ((d = m.n()).done)
										{
											e.next = 18;
							...
							var e = Object(u.a)(y.a.mark((function e(t, a, l, n, i)
							{
								...
								return y.a.wrap((function (e)
								{
									...
									case 0:
										...
										{}, t), [], l, n, i), m = Object(L.a)(a), e.prev = 6, m.s();
									case 8:
										if ((d = m.n()).done)
										{
											e.next = 23;
										...
										return k = Object(f.a)(Object(f.a)(
										{}, r),
										{},
										{
											itemName: r.name,
				...
				{
					var a = this;
					Object(_.a)(this, e), this.roomLoadingCallbacks = [], this.roomLoadedCallbacks = [], this.roomSavedCallbacks = [], this.roomDeletedCallbacks = [], this.loadSerialized = function (e)
					{
						...
						var t = JSON.parse(e);
						a.newRoom(t.floorplan, t.items), a.roomLoadedCallbacks.forEach((function (e)
						{
							return "function" === typeof e && e()
						}))
					}, this.exportSerialized = function ()
					{
						...
						var m = {
							floorplan: a.floorplan.saveFloorplan(),
							items: t
						};
						return JSON.stringify(m)
					}, this.newRoom = function (e, t)
					{
						a.scene.clearItems(), a.floorplan.loadFloorplan(e), t.forEach((function (e)
						{
			...
			function ot(e)
			{
				var t = ["varying vec3 vWorldPosition;", "void main() {", "  vec4 worldPosition = modelMatrix * vec4( position, 1.0 );", "  vWorldPosition = worldPosition.xyz;", "  gl_Position = projectionMatrix * modelViewMatrix * vec4( position, 1.0 );", "}"].join("\n"),
					a = ["uniform vec3 topColor;", "uniform vec3 bottomColor;", "uniform float offset;", "varying vec3 vWorldPosition;", "void main() {", "  float h = normalize( vWorldPosition + offset ).y;", "  gl_FragColor = vec4( mix( bottomColor, topColor, (h + 1.0) / 2.0), 1.0 );", "}"].join("\n");
				! function ()
				{
					var l = {
							topColor:
							{
								type: "c",
								value: new ce.l(16777215)
							},
							bottomColor:
							{
								type: "c",
								value: new ce.l(15329769)
							},
							offset:
							{
								type: "f",
			...
			var mt = function (e, t)
				{
					this.object = e, this.domElement = void 0 !== t ? t : document, this.enabled = !0, this.target = new ce.Lb, this.center = this.target, this.noZoom = !1, this.zoomSpeed = 1, this.minDistance = 0, this.maxDistance = 1500, this.noRotate = !1, this.rotateSpeed = 1, this.noPan = !1, this.keyPanSpeed = 40, this.autoRotate = !1, this.autoRotateSpeed = 2, this.minPolarAngle = 0, this.maxPolarAngle = Math.PI / 2, this.noKeys = !1, this.keys = {
						LEFT: 37,
						UP: 38,
						RIGHT: 39,
						BOTTOM: 40
					}, this.cameraMovedCallbacks = [], this.needsUpdate = !0;
					var a = this,
						l = 1e-6,
						n = new ce.Kb,
						i = new ce.Kb,
					...
					}, this.pan = function (e)
					{
						...
						else void 0 !== a.object.top ? (a.panLeft(e.x * (a.object.right - a.object.left) / t.clientWidth), a.panUp(e.y * (a.object.top - a.object.bottom) / t.clientHeight)) : console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled.");
						a.update()
					...
					}, this.update = function ()
					{
						...
						var i = t.length() * y;
						i = Math.max(this.minDistance, Math.min(this.maxDistance, i)), this.target.add(u), t.x = i * Math.sin(n) * Math.sin(a), t.y = i * Math.cos(n), t.z = i * Math.sin(n) * Math.cos(a), e.copy(this.target).add(t), this.object.lookAt(this.target), h = 0, c = 0, y = 1, u.set(0, 0, 0), this.cameraMovedCallbacks.forEach((function (e)
						{
							return "function" === typeof e && e()
						})), this.needsUpdate = !0
					...
					}), !1), this.domElement.addEventListener("mousewheel", B, !1), this.domElement.addEventListener("DOMMouseScroll", B, !1), this.domElement.addEventListener("touchstart", (function (e)
					{
						if (!1 !== a.enabled) switch (e.touches.length)
						{
						case 1:
							if (!0 === a.noRotate) return;
					...
					}), !1), this.domElement.addEventListener("touchmove", (function (e)
					{
						if (!1 !== a.enabled)
						{
							...
							case 1:
								if (!0 === a.noRotate) return;
								if (k !== f) return;
								i.set(e.touches[0].pageX, e.touches[0].pageY), s.subVectors(i, n), a.rotateLeft(2 * Math.PI * s.x / t.clientWidth * a.rotateSpeed), a.rotateUp(2 * Math.PI * s.y / t.clientHeight * a.rotateSpeed), n.copy(i);
								break;
							case 2:
								if (!0 === a.noZoom) return;
								if (k !== L) return;
					...
					{
						if (!1 !== a.enabled && !0 !== a.noKeys && !0 !== a.noPan) switch (e.keyCode)
						{
						case a.keys.UP:
				...
				dt = function (e)
				{
					...
					function d(e)
					{
						n !== e && (m(), e.allowRotate && !e.fixed && (o = function (e)
						{
							var t = new ce.u,
								l = new ce.D(function (e)
								{
									var t = new ce.t;
									return t.vertices.push(new ce.Lb(0, 0, 0), c(e)), t
								}(e), (a.rotating, new ce.E(
								{
									color: p(),
									linewidth: 3,
									depthTest: !1
							...
							return t.add(l), t.add(n), t.add(i), t.rotation.y = e.rotation.y, t.position.x = e.position.x, t.position.z = e.position.z, t.position.y = .05, t
						}(n = e), l.add(o)))
					}
					...
					function c(e)
					{
						return new ce.Lb(0, 0, Math.max(e.halfSize.x, e.halfSize.z) + .2)
					}
					...
					}, e.itemSelectedCallbacks.push(d), e.itemUnselectedCallbacks.push(b)
				},
				bt = function (e, t, a, l, n, i)
				{
					var s = this;
					this.enabled = !0;
					var o, m, d, b, r, p = t.scene,
						c = !1,
						h = !1,
						y = !1,
						u = 0,
					...
					function S(e)
					{
						if (!ee.Configuration.getBooleanValue(ee.configSceneLocked) && s.enabled) switch (e.preventDefault(), h = !0, m.x = e.offsetX, m.y = e.offsetY, c || function ()
							{
								var e = i.getObject();
								if (null != e)
								{
					...
					function H(e)
					{
						if (!ee.Configuration.getBooleanValue(ee.configSceneLocked) && s.enabled) switch (e.preventDefault(), h = !1, c = !0, f)
						{
						case _:
					...
					function B(t)
					{
						...
						}(t)), f = t, i.setRotating(s.isRotating())
					}
					...
					this.needsUpdate = !0, this.isRotating = function ()
						...
						}, this.getIntersections = function (e, t, l, n, i, s)
						{
							...
							var o, m = w(e).sub(a.position).normalize(),
							...
							return n && (o = ee.Utils.removeIf(o, (function (e)
							{
								return !e.object.visible
							}))), l && (o = ee.Utils.removeIf(o, (function (e)
							{
			...
			function rt(e, t)
			{
				...
				this.getDirLight = function () {},
					function ()
					{
						...
						n.position.set(4, 5, 0), e.add(n), (a = new ce.jb(16777215, .4, 100, 2)).position.set(0, 5, 0), a.castShadow = !0, a.shadow.mapSize.width = 1024, a.shadow.mapSize.height = 1024, a.shadow.radius = 2, a.shadow.bias = 1e-4, e.add(a), t.fireOnUpdatedRooms(l)
					}()
			}
			var pt = function (e, t)
				{
					...
					a.room.fireOnFloorChange(n), l = i(), this.addToScene = function ()
					{
				...
				ct = function (e, t, a)
				{
					...
					function u()
					{
						...
						var r = a.object.position.clone(),
							...
							c = r.sub(p).normalize(),
							h = b.dot(c);
						l.visible = h >= 0, s.forEach((function (e)
						{
							e.visible = l.visible
					...
					function g()
					{
						d = new ce.V(
						{
							...
							map: m,
							transparent: !0,
							opacity: ee.Configuration.getBooleanValue(ee.configXRayMode) ? .3 : 1
						}), b = new ce.V(
						{
							color: r,
							side: ce.o,
							transparent: !0,
							opacity: ee.Configuration.getBooleanValue(ee.configXRayMode) ? .3 : 1
						}), s.push(x(t.exteriorStart(), t.exteriorEnd(), t.exteriorTransform, t.invExteriorTransform, b)), s.push(x(t.interiorStart(), t.interiorEnd(), t.interiorTransform, t.invInteriorTransform, d)), o.push(f(t, 0, ce.c, 14540253)), s.push(f(t, n.height, ce.o, r)), s.push(D(t.interiorStart(), t.exteriorStart(), n.height, p)), s.push(D(t.interiorEnd(), t.exteriorEnd(), n.height, p))
					}
					...
					function x(e, t, a, l, i)
					{
						...
						p.faceVertexUvs[0] = [], p.faces.forEach((function (e)
						{
							var t = p.vertices[e.a],
								a = p.vertices[e.b],
								l = p.vertices[e.c];
							p.faceVertexUvs[0].push([y(t), y(a), y(l)])
						})), p.faceVertexUvs[1] = p.faceVertexUvs[0], p.computeFaceNormals(), p.computeVertexNormals();
						var u = new ce.Q(p, i);
					...
					function D(e, t, a, l)
					{
						...
						{
							i.vertices.push(e)
						})), i.faces.push(new ce.q(0, 1, 2)), i.faces.push(new ce.q(0, 2, 3));
						var s = new ce.V(
						{
							color: l,
							side: ce.o
					...
					this.visible = !1, document.addEventListener(ee.BP3D_EVENT_CONFIG_CHANGED, (function (e)
					{
						var t = e.detail;
						if (t && t.hasOwnProperty(ee.configXRayMode) && d && b)
						{
							var a = 1;
							t[ee.configXRayMode] && (a = .3), d.opacity = a, b.opacity = a
						}
					...
					}, t.redrawCallbacks.push(c), a.cameraMovedCallbacks.push(u), _(), g(), y()
				},
				ht = function (e, t, a)
				{
					var l = this,
					...
					function i()
					{
						...
						{
							e.remove()
						})), n.floors = [], n.edges = [], n.floorplan.getRooms().forEach((function (t)
						{
							var a = new pt(e, t);
					...
					this.scene = e, this.floorplan = t, this.controls = a, this.floors = [], this.edges = [], t.fireOnUpdatedRooms(i), this.updateHeight = function (e)
					{
						e > 0 && (ee.Configuration.setValue("wallHeight", e), l.floorplan.walls.forEach((function (t)
						{
							return t.height = e
						})), i())
					}
				...
				{
					var a = this;
					Object(_.a)(this, e), this.dom = null, this.value = 0, this.events = {}, this.handleUnitChanged = function (e)
					{
					...
					{
						return a.events[e] = t
					}, this.dom = document.createElement("div"), this.dom.setAttribute("style", "display: flex; width: inherit; align-items: center;"), this.dom.insertAdjacentHTML("beforeend", "<label>".concat(t, "</label>")), this.cmInputContainer = document.createElement("div"), this.inputCm = document.createElement("input"), this.inputCm.setAttribute("type", "number"), this.inputCm.setAttribute("placeholder", t), this.inputCm.setAttribute("min", 0), this.inputCm.value = 0, this.inputCm.style.width = "80px", this.inputCm.addEventListener("change", (function (e)
					{
						var t = e.target.value;
						"function" === typeof a.events.change && a.events.change(t / Dt), a.setValue(t / Dt)
					})), this.cmInputContainer.appendChild(this.inputCm), this.cmInputContainer.insertAdjacentHTML("beforeend", "<label>cm</label>"), this.dom.appendChild(this.cmInputContainer), this.inchInputContainer = document.createElement("div"), this.inputInch = document.createElement("input"), this.inputInch.setAttribute("type", "number"), this.inputInch.setAttribute("placeholder", t), this.inputInch.setAttribute("min", 0), this.inputInch.value = 0, this.inputInch.style.width = "80px", this.inputInch.addEventListener("change", (function (e)
					{
						var t = 2.54 * e.target.value;
						"function" === typeof a.events.change && a.events.change(t / Dt), a.setValue(t / Dt)
					})), this.inchInputContainer.appendChild(this.inputInch), this.inchInputContainer.insertAdjacentHTML("beforeend", '<label>"</label>'), this.dom.appendChild(this.inchInputContainer), this.feetInputContainer = document.createElement("div"), this.inputFeet1 = document.createElement("input"), this.inputFeet1.setAttribute("type", "number"), this.inputFeet1.setAttribute("placeholder", t), this.inputFeet1.setAttribute("min", 0), this.inputFeet1.value = 0, this.inputFeet1.style.width = "40px", this.inputFeet1.addEventListener("change", (function (e)
					{
					...
					})), this.feetInputContainer.appendChild(this.inputFeet1), this.feetInputContainer.insertAdjacentHTML("beforeend", "<label>'</label>"), this.inputFeet2 = document.createElement("input"), this.inputFeet2.setAttribute("type", "number"), this.inputFeet2.setAttribute("placeholder", t), this.inputFeet2.setAttribute("min", 0), this.inputFeet2.value = 0, this.inputFeet2.style.width = "40px", this.inputFeet2.addEventListener("change", (function (e)
					{
						if ("function" === typeof a.events.change)
						{
							var t = 30.48 * a.inputFeet1.value + 2.54 * a.inputFeet2.value;
					...
					})), this.feetInputContainer.appendChild(this.inputFeet2), this.feetInputContainer.insertAdjacentHTML("beforeend", '<label>"</label>'), this.dom.appendChild(this.feetInputContainer), document.addEventListener(ee.BP3D_EVENT_CONFIG_CHANGED, (function (e)
					{
						var t = e.detail;
				...
				Lt = function ()
				{
					...
					{
						var l = this;
						Object(_.a)(this, e), this.container = null, this.dimensionInput = null, this.btnDelete = null, this.edge = null, this.visible = !1, this.wall = null, this.events = {}, this.texturePresets = [], this.addEventListener = function (e, t)
						{
							return l.events[e] = t
						}, this.setEdge = function (e)
						{
							return l.edge = e
						}, this.main = a, this.container = document.createElement("div"), this.container.setAttribute("class", "custom-context-menu");
						var n = document.createElement("div");
						n.setAttribute("class", "item-container"), this.dimensionInput = new ft("Height"), this.dimensionInput.addEventListener("change", (function (e)
						{
							e > 0 && l.events.heightChanged(e)
						})), n.appendChild(this.dimensionInput.dom), this.container.appendChild(n);
						var i = document.createElement("div");
						i.setAttribute("class", "item-container"), i.setAttribute("style", "display: flex;"), this.selectTexture = document.createElement("select"), this.selectTexture.insertAdjacentHTML("beforeend", "<option>asdf</option><option>qwer</option>"), this.selectTexture.addEventListener("change", (function (e)
						{
							var t = e.target.value;
						...
						})), i.appendChild(this.selectTexture), this.container.appendChild(i), t.appendChild(this.container), this.setVisible(!1), this.setTexturePresets([])
					}
					return Object(g.a)(e, [
					{
						key: "setVisible",
				...
				vt = function ()
				{
					...
					{
						var l = this;
						Object(_.a)(this, e), this.container = null, this.dimensionInput = null, this.btnDelete = null, this.visible = !1, this.floor = null, this.texturePresets = [], this.events = {}, this.setFloor = function (e)
						{
							return l.floor = e
						}, this.main = a, this.container = document.createElement("div"), this.container.setAttribute("class", "custom-context-menu");
						var n = document.createElement("div");
						n.setAttribute("class", "item-container"), n.setAttribute("style", "display: flex;"), this.selectTexture = document.createElement("select"), this.selectTexture.insertAdjacentHTML("beforeend", "<option>asdf</option><option>qwer</option>"), this.selectTexture.addEventListener("change", (function (e)
						{
							var t = e.target.value;
						...
						})), n.appendChild(this.selectTexture), this.container.appendChild(n), t.appendChild(this.container), this.setVisible(!1), this.setTexturePresets([])
					}
					return Object(g.a)(e, [
					{
						key: "setVisible",
				...
				kt = function (e, t, a, l)
				{
					...
					this.dataUrl = function ()
						...
						}, this.updateWindowSize = function ()
						{
							...
							i.heightMargin = e.top, i.widthMargin = e.left, i.elementWidth = e.width, i.elementHeight = e.height, d.aspect = i.elementWidth / i.elementHeight, d.updateProjectionMatrix(), b.setSize(i.elementWidth, i.elementHeight), r.setSize(i.elementWidth, i.elementHeight), !0
						...
						{
							var t = this;
							p.selectedObjects = [], Array.isArray(e) && e.forEach((function (e)
							{
						...
						}, this.showAllGizmo = function ()
						{
							try
							{
								console.log("show all gizmo"), u.items.forEach((function (e)
								{
						...
						}, this.hideAllGizmo = function ()
						{
							try
							{
								console.log("hide all gizmo"), u.items.forEach((function (e)
								{
						...
						function ()
						{
							m = i.element, d = new ce.gb(45, 1, 1, 1e4), (b = new ce.Ob(
							{
								antialias: !0,
								preserveDrawingBuffer: !0
							})).autoClear = !1, b.shadowMap.enabled = !0, b.shadowMapSoft = !0, b.shadowMap.type = ce.eb, b.toneMappingExposure = 1, b.outputEncoding = ce.Pb, (new ce.Gb).load("".concat("/Blueprint3D-assets/textures/room-hdr-01.jpg"), (function (e)
							{
								e.mapping = ce.p, u.environment = u.scene.environment = e
							})), new ot(u), i.controls = new mt(d, m);
							...
							r.addPass(a), (p = new xt.a(new ce.Kb(t.width, t.height), u.scene, d)).renderToScreen = !0, p.depthMaterial.morphTargets = !0, p.prepareMaskMaterial.morphTargets = !0, p.edgeStrength = 20, p.edgeGlow = .3, p.edgeThickness = .5, p.pulsePeriod = 2, p.visibleEdgeColor = new ce.l(0, 0, 1), p.hiddenEdgeColor = new ce.l(0, 0, 1), r.addPass(p), (c = new _t.a(gt.a)).uniforms.resolution.value.set(1 / t.width, 1 / t.height), r.addPass(c), n.outlineManager = p, i.updateWindowSize(), s.resize && window.addEventListener("resize", i.updateWindowSize), i.centerCamera(), e.floorplan.fireOnUpdatedRooms(i.centerCamera), new rt(u, e.floorplan), y = new ht(u, e.floorplan, i.controls), g(), i.element.addEventListener("mouseenter", (function ()
							{
								!0
							...
							})), n.wallContextMenu = new Lt(n.element.parentNode, n), n.wallContextMenu.addEventListener("heightChanged", n.handleWallHeightChanged), n.floorContextMenu = new vt(n.element.parentNode, n)
						}()
				},
				Tt = function ()
				{
					...
					{
						var l = this;
						Object(_.a)(this, e), this.container = null, this.dimensionInput = null, this.btnDelete = null, this.visible = !1, this.wall = null, this.isVisible = function ()
						{
							return l.visible
						...
						}, this.planner = a, this.container = document.createElement("div"), this.container.setAttribute("class", "custom-context-menu");
						var n = document.createElement("div");
						n.setAttribute("class", "item-container"), this.dimensionInput = new ft("Length"), this.dimensionInput.addEventListener("change", (function (e)
						{
							l.handleResize(e)
						})), n.append(this.dimensionInput.dom), this.container.append(n);
						var i = document.createElement("div");
						i.setAttribute("class", "item-container"), this.checkLock = document.createElement("input"), this.checkLock.setAttribute("type", "checkbox"), this.checkLock.style.width = "initial", this.checkLock.addEventListener("click", (function (e)
						{
							l.wall && l.wall.setLocked(l.checkLock.checked), l.dimensionInput.setDisabled(!!l.checkLock.checked)
						})), i.append(this.checkLock), i.insertAdjacentHTML("beforeend", "<label>Lock</label>"), this.container.append(i), (i = document.createElement("div")).setAttribute("class", "item-container"), this.btnDelete = document.createElement("button"), this.btnDelete.innerHTML = "Delete", this.btnDelete.addEventListener("click", (function ()
						{
							l.wall && l.wall.remove(), l.setVisible(!1), a.view.draw()
						})), i.append(this.btnDelete), this.container.append(i), t.append(this.container)
					}
					return Object(g.a)(e, [
					{
						key: "setVisible",
						...
						value: function (e)
						{
							if (e > 0)
							{
								...
								if (this.wall.start.locked || this.wall.end.locked)
									if (this.wall.start.locked && !this.wall.end.locked) a = {
								...
								var l = 0,
									n = 0;
								l = a.x + (this.wall.start.x - a.x) * t, n = a.y + (this.wall.start.y - a.y) * t, this.wall.start.move(l, n, !1), l = a.x + (this.wall.end.x - a.x) * t, n = a.y + (this.wall.end.y - a.y) * t, this.wall.end.move(l, n, !1), this.planner.view.draw()
							}
						}
					}]), e
				}(),
				St = function ()
				{
					...
					{
						var n = this;
						Object(_.a)(this, e), this.parent = null, this.mode = 0, this.activeWall = null, this.activeCorner = null, this.activeItem = null, this.originX = 0, this.originY = 0, this.targetX = 0, this.targetY = 0, this.lastNode = null, this.modeResetCallbacks = [], this.mouseDown = !1, this.mouseMoved = !1, this.mouseX = 0, this.mouseY = 0, this.rawMouseX = 0, this.rawMouseY = 0, this.lastX = 0, this.lastY = 0, this.itemSelectedCallbacks = [], this.itemUnselectedCallbacks = [], this.parent = l, this.zoomLevel = 100, this.scale = 100, this.floorplan = a, this.canvasElement = t, this.elWallContextMenu = null, this.view = new be(this.floorplan, this, t);
						this.cmPerPixel = 2.032, this.pixelsPerCm = 1 / this.cmPerPixel, this.wallWidth = 10 * this.pixelsPerCm, this.setMode(te);
						var i = this;
						this.initializeContextMenu(), this.canvasElement.addEventListener("contextmenu", (function (e)
						{
							e.preventDefault(), e.stopPropagation(), n.activeWall ? (n.elWallContextMenu.setVisible(!0), n.elWallContextMenu.setPosition(e.offsetX, e.offsetY), n.elWallContextMenu.setWall(n.activeWall)) : n.elWallContextMenu.setVisible(!1)
					...
					},
					{
						...
						value: function ()
						{
							this.mode === ae && this.lastNode ? (Math.abs(this.mouseX - this.lastNode.x) < .25 ? this.targetX = this.lastNode.x : this.targetX = this.mouseX, Math.abs(this.mouseY - this.lastNode.y) < .25 ? this.targetY = this.lastNode.y : this.targetY = this.mouseY) : (this.targetX = this.mouseX, this.targetY = this.mouseY), this.view.draw()
						}
					},
					{
						key: "mouseWheel",
					...
					},
					{
						...
						value: function (e)
						{
							this.elWallContextMenu.isVisible() ? this.elWallContextMenu.setVisible(!1) : (this.mouseDown = !0, this.mouseMoved = !1, this.lastX = this.rawMouseX, this.lastY = this.rawMouseY, this.mode === le && (this.activeCorner ? this.activeCorner.removeAll() : this.activeWall ? this.activeWall.remove() : this.setMode(te)))
						}
					},
					{
						key: "mousemove",
						value: function (e)
						{
							...
							{
								if (this.mouseMoved = !0, this.rawMouseX = e.clientX, this.rawMouseY = e.clientY, this.mouseX = (e.clientX - this.canvasElement.getBoundingClientRect().left) * this.cmPerPixel + this.originX * this.cmPerPixel, this.mouseY = (e.clientY - this.canvasElement.getBoundingClientRect().top) * this.cmPerPixel + this.originY * this.cmPerPixel, this.mouseX /= this.zoomLevel, this.mouseY /= this.zoomLevel, (this.mode === ae || this.mode === te && this.mouseDown) && this.updateTarget(), this.mode !== ae && !this.mouseDown)
								{
									var t = this.floorplan.overlappedCorner(this.mouseX, this.mouseY),
										...
										n = !1;
									t !== this.activeCorner && (this.activeCorner = t, n = !0), a !== this.activeWall && (this.activeWall = a, n = !0), l !== this.activeItem && (this.activeItem = l, n = !0), n && this.view.draw()
								}
								if (!this.mouseDown || this.activeCorner || this.activeWall || this.activeItem || (this.originX += this.lastX - this.rawMouseX, this.originY += this.lastY - this.rawMouseY, this.lastX = this.rawMouseX, this.lastY = this.rawMouseY, this.view.draw()), this.mode === te && this.mouseDown)
								{
									if (this.activeCorner) this.activeCorner.move(this.mouseX, this.mouseY);
										...
										if (1 === e.buttons) this.activeItem.moveToPosition(
										{
											x: this.mouseX,
					...
					},
					{
						...
						value: function ()
						{
							...
							if (!this.elWallContextMenu.isVisible())
							{
								...
								this.activeItem ? this.itemSelectedCallbacks.forEach((function (t)
								{
					...
					},
					{
						...
						value: function (e)
						{
							this.lastNode = null, this.mode = e, this.modeResetCallbacks.forEach((function (t)
							{
								return "function" === typeof t && t(e)
							})), this.updateTarget()
						}
				...
				Ht = function e(t)
				{
					Object(_.a)(this, e), this.changeUnit = function (e)
					{
						switch (e)
						{
						case "cm":
					...
					}, this.model = new st(t.textureDir), this.three = new kt(this.model, t.threeElement, t.threeCanvasElement,
			...
			function Bt(e)
			{
				...
				return Object(v.jsx)("div",
				{
					...
					children: Object(v.jsxs)("div",
					{
						...
						{
							children: "Do you want to swap current product?"
						}), Object(v.jsxs)("div",
						{
							className: "buttons",
			...
			var wt = function (e)
				{
					...
					{
						var l;
						return Object(_.a)(this, a), (l = t.call(this, e)).initializeBP3D = function ()
						{
							var e = {
								floorplannerElement: l.elFloorPlannerElement,
								threeElement: l.elThreeElemContainer,
								textureDir: "models/textures/",
								widget: !1
							};
							l.bp3d = new Ht(e), l.bp3d.model.loadSerialized(l.props.defaultJson ? l.props.defaultJson : JSON.stringify(Ct)), l.bp3d.three.itemSelectedCallbacks.push(l.handleItemSelected), l.bp3d.three.itemUnselectedCallbacks.push(l.handleItemUnselected), l.bp3d.floorplanner.itemSelectedCallbacks.push(l.handleItemSelected), l.bp3d.floorplanner.itemUnselectedCallbacks.push(l.handleItemUnselected)
						...
						{
							e.measureUnit !== l.props.measureUnit && l.bp3d.changeUnit(e.measureUnit), e.viewMode !== l.props.viewMode && setTimeout((function ()
							{
						...
						}, l.handleItemSelected = function (e)
						{
							...
							{
								selectedItem: e
							}), "function" === typeof l.props.onItemSelected && l.props.onItemSelected(e)
						}, l.handleItemUnselected = function ()
						{
							l.setState(
							{
								selectedItem: null
							}), "function" === typeof l.props.onItemUnselected && l.props.onItemUnselected()
						}, l.update = function ()
						{
							try
							{
						...
						}, l.getDefaultData = function (e)
						{
							...
							return {
								defaultMorph: t,
								defaultStyles: i,
								metadata: Object(f.a)(Object(f.a)(
								{}, e),
								{},
								{
									itemName: e.name,
						...
						{
							l.bp3d.model.scene.importSetFromBuilder(
							{
								itemName: "Imported Set",
								items: e
							}, e)
						}, l.addSet = function (e)
						{
							var t = Object(f.a)(Object(f.a)(
							{}, e),
							{},
							{
								itemName: e.name
						...
						{
							var e = Object(u.a)(y.a.mark((function e(t, a)
							{
								var n, i, s, o, m, d, b, r;
								return y.a.wrap((function (e)
								{
									...
									case 0:
										...
										return i = n.linkedItems[t], s = i.position, o = i.rotation.y, m = i.getOptions(), n.linkedItems[t].remove(), d = l.getDefaultData(a), b = d.metadata, e.next = 10, l.bp3d.model.scene.addItem(a.type, a.model, b, s, o, m, !1);
									case 10:
						...
						{
							l.state.selectedItem && l.state.selectedItem.updateMaterial(e, t, a, (function ()
							{
								return setTimeout(l.update, 100)
							}))
						}, l.updateStyle = function (e, t)
						{
							l.state.selectedItem && l.state.selectedItem.updateStyle(e, t, (function ()
							{
								return setTimeout(l.update, 100)
							}))
					...
					return Object(g.a)(a, [
					{
						...
						value: function ()
						{
							...
							return Object(v.jsxs)("div",
							{
								...
								}), this.state.showSwapDialog && Object(v.jsx)(Bt,
								{
									onConfirm: function ()
									{
										e.setState(
										{
											showSwapDialog: !1
										}), e.replaceItem(e.state.newProduct)
									},
									onCancel: function ()
									{
										return e.setState(
				...
				Ot = function (e)
				{
					...
					{
						var l;
						return Object(_.a)(this, a), (l = t.call(this, e)).filterCategories = function (e)
						{
						...
						}, l.renderProducts = function (e)
						{
							return Object(v.jsx)("div",
							{
								...
								children: e && Array.isArray(e) && e.map((function (e, t)
								{
									return Object(v.jsxs)("div",
									{
					...
					return Object(g.a)(a, [
					{
						...
						value: function ()
						{
							...
							return Object(v.jsxs)("div",
							{
								...
								}), Array.isArray(l) && l.map((function (t, l)
								{
									return Object(v.jsxs)("div",
									{
										children: [Object(v.jsxs)("div",
										{
											...
											onClick: function ()
											{
												return e.setState(
												{
													activeCategory: l === a ? -1 : l
												})
											},
											children: ["".concat(t.category, " "), Object(v.jsx)("span",
											{
												style:
												{
													color: "#aaa"
												},
												children: "(".concat(t.styles.length, ")")
											})]
				...
				jt = function (e)
				{
					...
					{
						var l;
						return Object(_.a)(this, a), (l = t.call(this, e)).state = {
							opened: !1
						}, l
					}
					return Object(g.a)(a, [
				...
				Et = (a(28), [
				{
					font: "fas fa-arrows-alt",
					value: 0,
					rotation: 0
				},
				{
					font: "fas fa-arrow-left",
					value: 1,
					rotation: 0
				},
				{
				...
				Wt = function (e)
				{
					...
					{
						var l;
						return Object(_.a)(this, a), (l = t.call(this, e)).componentDidMount = function ()
						{
						...
						}, l.handleImportClicked = function ()
						{
							try
							{
								l.refBuilder.contentWindow.postMessage(
								{
									call: "req-import-set"
								}, "*")
							}
						...
						{
							l.state.alreadyImported || Array.isArray(e.data) && (l.setState(
							{
								alreadyImported: !0
							}), "function" === typeof l.props.onImported && l.props.onImported(e.data))
						}, l.state = {
							alreadyImported: !1
						}, l.refBuilder = null, l
					}
				...
				Rt = function (e)
				{
					...
					{
						var l;
						return Object(_.a)(this, a), (l = t.call(this, e)).handleUnitChanged = function ()
						{
							var e = l.state.unit,
								t = Gt.indexOf(e);
							t = (t + 1) % Gt.length;
							...
							{
								unit: a
							}), l.props.onUnitChanged(a.toLowerCase())
						}, l.handleToggleLock = function ()
						{
							l.props.onLockSceneToggled(!l.state.locked), l.setState(
							{
								locked: !l.state.locked
							})
						}, l.handleToggleDimensions = function ()
						{
							l.props.onShowDimensionsToggled(!l.state.showDimension), l.setState(
							{
								showDimension: !l.state.showDimension
							})
						}, l.handleToggleSnap = function ()
						{
							l.props.onSnapToggled(!l.state.snap), l.setState(
							{
								snap: !l.state.snap
							})
						}, l.handleToggleXRay = function ()
						{
							l.props.onXRayToggled(!l.state.xRay), l.setState(
							{
								xRay: !l.state.xRay
							})
						}, l.getButtons = function ()
						{
							...
							},
							{
								font: "far fa-image",
								tooltip: "Screenshot",
								callback: l.props.onSnapshotClicked
							}, null,
							{
								font: "",
								label: l.state.unit,
				...
				It = function (e)
				{
					...
					function a()
					{
						...
						Object(_.a)(this, a);
						for (var l = arguments.length, n = new Array(l), i = 0; i < l; i++) n[i] = arguments[i];
						return (e = t.call.apply(t, [this].concat(n))).handleMaterialChange = function (t, a)
						{
					...
					return Object(g.a)(a, [
					{
						...
						value: function ()
						{
							...
							return Object(v.jsxs)("div",
							{
								...
								children: [!e && Object(v.jsx)("p",
								{
									children: "No item selected"
								}), e && this.renderMaterialSection(), e && this.renderStyleSection()]
							})
						}
					}]), a
				}(r.a.Component);
			...
			var zt = function (e)
				{
					...
					function a()
					{
						...
						Object(_.a)(this, a);
						for (var l = arguments.length, n = new Array(l), i = 0; i < l; i++) n[i] = arguments[i];
						return (e = t.call.apply(t, [this].concat(n))).renderMorphingSection = function ()
						{
							var t = e.props.info;
							if (t && t.metadata && Array.isArray(t.metadata.morph)) return t.metadata.morph.map((function (a, l)
							{
								return Object(v.jsx)(Ut,
								{
									item: a,
									info: t,
									onChange: e.props.onMorphChanged
								}, l)
							}))
						}, e._renderGroupInfo = function (t)
						{
							...
							{
								children: t.hasOwnProperty("opened") ? Object(v.jsxs)(v.Fragment,
								{
									...
									{})]
								}) : t.groupParent && t.groupParent.hasOwnProperty("opened") ? Object(v.jsxs)(v.Fragment,
								{
									children: [Object(v.jsx)("hr",
									{}), Object(v.jsxs)("div",
									{
						...
						}, e._renderInfo = function (t)
						{
							return Object(v.jsxs)("div",
							{
								...
								{
									children: t && t.metadata ? t.metadata.itemName : ""
								}), e._renderGroupInfo(t), e.renderMorphingSection()]
							})
						}, e
					}
					return Object(g.a)(a, [
					{
						...
						value: function ()
						{
							...
							return Object(v.jsxs)("div",
							{
								...
								children: [e && this._renderInfo(e), !e && Object(v.jsx)("p",
								{
									children: "No item selected"
								})]
							})
				...
				{
					label: "Seamless 1",
					texture: "/blueprint3D-assets/textures/seamless-01.jpg",
					width: 35,
					height: 35
				},
				{
					label: "Seamless 2",
					texture: "/blueprint3D-assets/textures/seamless-02.jpg",
					width: 35,
					height: 35
				},
				{
				...
				{
					label: "Clear",
					texture: "/blueprint3D-assets/textures/frosted-0.jpg",
					width: 35,
					height: 35
				},
				{
					label: "25% Frosted",
					texture: "/blueprint3D-assets/textures/frosted-25.jpg",
					width: 35,
					height: 35
				},
				{
					label: "50% Frosted",
					texture: "/blueprint3D-assets/textures/frosted-50.jpg",
					width: 35,
					height: 35
				},
				{
					label: "75% Frosted",
					texture: "/blueprint3D-assets/textures/frosted-75.jpg",
					width: 35,
					height: 35
				},
				{
					label: "100% Frosted",
					texture: "/blueprint3D-assets/textures/frosted-100.jpg",
					width: 35,
					height: 35
				}],
				At = [
				{
					label: "Silver",
					texture: "/blueprint3D-assets/textures/silver.jpg",
					width: 100,
					height: 100
				},
				{
					label: "Black",
					texture: "/blueprint3D-assets/textures/black.jpg",
					width: 100,
					height: 100
				}],
				Kt = [
				...
				{
					label: "Acrylic",
					name_in_model: "modesty-16ma"
				},
				{
					label: "Laminate",
					name_in_model: "modesty-16ml"
				}],
				Yt = [].concat(Kt, [
				{
					label: "TLEG",
				...
				Qt = [
				{
					label: "NG",
					name_in_model: "",
					thumbnail: "/blueprint3D-assets/textures/thumb-grommet-ng.jpg"
				},
				{
					label: "LG",
					name_in_model: "grommet-lg",
					thumbnail: "/blueprint3D-assets/textures/thumb-grommet-lg.jpg"
				},
				{
					label: "CG",
					name_in_model: "grommet-cg",
					thumbnail: "/blueprint3D-assets/textures/thumb-grommet-cg.jpg"
				},
				{
					label: "RG",
					name_in_model: "grommet-rg",
					thumbnail: "/blueprint3D-assets/textures/thumb-grommet-rg.jpg"
				},
				{
					label: "LRG",
					name_in_model: "grommet-lrg",
					thumbnail: "/blueprint3D-assets/textures/thumb-grommet-lrg.jpg"
				}],
				Jt = [
				{
					label: "NG",
				...
				ea = [
				{
					label: 'Bar 5" Pull Nickel',
					name_in_model: 'handle-optional-5"-bar-pull-nickel'
				},
				{
					label: 'Loop 5" Black',
					name_in_model: 'handle-optional-5"-loop-black'
				},
				{
					label: 'Loop 5" Nickel',
					name_in_model: 'handle-optional-5"-loop-nickel'
				},
				{
					label: 'Square 5" Nickel',
					name_in_model: 'handle-optional-5"-square-nickel'
				},
				{
					label: 'Strait 5" Pull Black',
					name_in_model: 'handle-optional-5"-strait-pull-black'
				},
				{
					label: 'Strait 5" Pull Silver',
					name_in_model: 'handle-optional-5"-strait-pull-silver'
				},
				{
					label: 'Waterfall 5" Black',
					name_in_model: 'handle-optional-5"-waterfall-black'
				}],
				ta = [
				{
					label: 'Bar 5" Pull Nickel',
					name_in_model: 'filing-handle-5"-bar-pull-nickel'
				},
				{
					label: 'Loop 5" Black',
					name_in_model: 'filing-handle-5"-loop-black'
				},
				{
					label: 'Loop 5" Nickel',
					name_in_model: 'filing-handle-5"-loop-nickel'
				},
				{
					label: 'Square 5" Nickel',
					name_in_model: 'filing-handle-5"-square-nickel'
				},
				{
					label: 'Strait 5" Pull Black',
					name_in_model: 'filing-handle-5"-strait-pull-black'
				},
				{
					label: 'Strait 5" Pull Silver',
					name_in_model: 'filing-handle-5"-strait-pull-silver'
				},
				{
					label: 'Waterfall 5" Black',
					name_in_model: 'filing-handle-5"-waterfall-black'
				}],
				aa = [
				{
					label: "Glass Doors",
					name_in_model: "door-gd",
					thumbnail: "/blueprint3D-assets/textures/thumb-door-glass.jpg"
				},
				{
					label: "Panel Doors",
					name_in_model: "door-pd",
					thumbnail: "/blueprint3D-assets/textures/thumb-door-panel.jpg"
				}],
				la = [
				{
					label: "Top",
					name_in_model: "cabinet-top-t"
				},
				{
					label: "No Top",
					name_in_model: "cabinet-top-nt"
				}],
				na = [
				{
					label: "Lock",
				...
				da = {
					...
					{
						name: 'Door 80"x37"',
						image: "/blueprint3D-assets/models/thumbnails/door-single.jpg",
						model: "/blueprint3D-assets/models/glb/door.glb",
						type: "7"
					}]
				},
				ba = {
				...
				ha = {
					...
					styles: [
					{
						...
						{
							label: "Laminate Face",
							name_in_model: "cabinet-face-laminate",
							types: Nt
						},
						{
							label: "Body",
				...
				Sa = {
					...
					styles: [
					{
						name: "BC-MB",
						image: "/blueprint3D-assets/models/thumbnails/br-bml.jpg",
						model: "/blueprint3D-assets/models/glb/S1 without texture.glb",
						type: "1",
						stackontop: !0,
						morph: [
						{
				...
				Ba = {
					...
					},
					{
						...
						{
							label: "Metal Face",
							name_in_model: "cabinet-face-metal",
							types: At
						},
						{
							label: "Body",
				...
				{
					label: "Top",
					name_in_model: "cabinet-top-laminate"
				},
				{
					label: "No Top",
					name_in_model: ""
				...
				},
				{
					...
					name_in_model: "grommet-2scp",
					thumbnail: "/blueprint3D-assets/textures/thumb-grommet-cog.jpg"
				}]), [ia, sa, Sa, ma, Ha, Oa, ca, Fa, wa, ha, ya, ua, _a, ga, fa, va, Da, xa, La, ka, Ta, pa, ba, ra, Ba, oa, ja, Ca, da, Ea]),
				Wa = (a(56), function (e)
				{
					Object(x.a)(a, e);
					var t = Object(D.a)(a);
					...
					{
						var l;
						return Object(_.a)(this, a), (l = t.call(this, e)).handleItemSelected = function (e)
						{
							l.setState(
							{
								selectedItem: e
						...
						}, l.handleSwitchMode = function ()
						{
							return l.setState(
							{
								viewMode: "3d" === l.state.viewMode ? "2d" : "3d"
							})
							...
							var e = Object(u.a)(y.a.mark((function e(t)
							{
								return y.a.wrap((function (e)
								{
									...
									case 0:
										...
										{
											showLoadingScreen: !0
										}), console.log("item", t), e.next = 4, l.refBp3d.addItem(t);
									case 4:
										l.setState(
										{
											showLoadingScreen: !1
										...
										children: [Object(v.jsx)("div",
										{
											...
											children: Object(v.jsx)(Rt,
											{
												...
												onAddProductClicked: function ()
												{
													return e.setState(
													{
														showProducts: !e.state.showProducts
													})
												},
				...
				Ga = function (e)
				{
					e && e instanceof Function && a.e(3).then(a.bind(null, 60)).then((function (t)
					{
						var a = t.getCLS,
							l = t.getFID,
							n = t.getFCP,
			...
			c.a.render(Object(v.jsx)(r.a.StrictMode,
			{
				children: Object(v.jsx)(Wa,
				{})
			}), document.getElementById("root")), Ga()
		}
	},
	[
		[57, 1, 2]
